...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('onn poda myre ʀᴇ ʙᴜᴛᴛᴏɴ𝘀', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="▣▢▢▢▢"
    ...
    elif query.data == "tipsto":  
        await query.answer("📗 - Pʟᴇᴀsᴇ Tʏᴘᴇ Mᴏᴠɪᴇ Cᴏʀʀᴇᴄᴛ Sᴘᴇʟʟɪɴɢ Lɪᴋᴇ Gᴏᴏɢʟᴇ\n\n📗 - Pʟᴇᴀsᴇ Eɴᴛᴇʀ Mᴏᴠɪᴇ Yᴇᴀʀ Lɪᴋᴇ ➤ Mᴀʟɪᴋ 𝟸𝟶𝟸𝟷\n\n©CɪɴᴇᴍᴀCᴏᴍᴘᴀɴʏ ", show_alert=True)   
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="ɴᴏ ᴍᴏʀᴇ ᴘᴀɢᴇ ᴀᴠᴀɪʟᴀʙʟᴇ", callback_data="pages")]
        )
